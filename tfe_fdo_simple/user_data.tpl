...
chmod 655 /tmp/terraform/terraform.hclic
...
services:
  tfe:
    ...
    depends_on:
      ...
      - postgres
    environment:
      TFE_HOSTNAME: "$(ec2-metadata -v | cut -d " " -f 2)"
...
export IACT_TOKEN=$(sudo docker exec terraform-enterprise-tfe-1 tfectl admin token)

# 초기 사용자 생성
tee payload.json -<<EOF
{
  "username": "admin",
  "email": "admin@insideinfo.co.kr",
  "password": "insideinfoinsideinfo"
}
EOF
