...
#   # 해당 블록이 없어도 동일하게 import 됨
#   dynamic "route" {
#     for_each = local.map_of_route_objects
#     content {
...
# locals {
#   #
#   indices_routes = range(length(data.aws_route_table.garget.routes))
#   map_of_route_objects = zipmap(
#     local.indices_routes,
#     data.aws_route_table.garget.routes
#   )
#   # 방법 1.
...
# #   value = local.map_of_route_objects
# # }
